...
@include('sweetalert::alert')
                <div class="container-fluid">
                    <form action="{{ route('postUpdatePost', ['id' => $post->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-3">
                        <!-- Area Chart -->
                        <div class="col-xl-10 col-lg-7">
                                    ...
                                    <div class="add-product-are">
                                        ...
                                        <!-- <div class="select-thumbnail mg-bottom-30"> -->
                                            <div class="padding-30">
                                                <div class="continent">
                                                    <div class="img-post">
                                                        <img id="image-thumbnail" src="{{ $post->LinkThumbnail }}" alt="" >
                                ...
                                <div class="card-body">
                                    <div class="add-product-are">
                                        ...
                                        <div class="padding-30">
                                            ...
                                            <input class="add-input" type="text" placeholder="Product Name" name="title" id="NameProduct" value="{{ $post->title }}"><br><br>
                                            <label class="add-lable" for="">URL</label><br>
                                            <input class="add-input" type="text" placeholder="URL" name="URL" id="URL" value="{{ $post->url }}"><br><br>
                            ...
                            <div class=" p-3">
                                <button type="submit" class="btn btn-success btn-icon-split float-right mb-5">
                                    <span class="text">Cập Nhật Bài Viết</span>
                                </button>
                            </div>
                        </div>
                    </div>
