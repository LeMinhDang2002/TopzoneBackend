...
@include('sweetalert::alert')
            <form action="{{ route('postAddProduct')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="add-product-are">
                                        ...
                                        <div class="padding-30">
                                            ...
                                            <input class="add-input" type="text" placeholder="Product Name" name="name_product" id="NameProduct"><br><br>
                                            <label class="add-lable" for="">Description</label><br>
                                            <input class="add-input" type="text" placeholder="Description" name="description" id="Description"><br><br>
                                            <label class="add-lable" for="">Phiên Bản</label><br>
                                            <input class="add-input" type="text" placeholder="Version" name="version" id="Version"><br><br>
                                            <label class="add-lable" for="">Số Lượng Trong Kho</label><br>
                                            <input class="add-input" type="text" placeholder="Quantity" name="quantity" id="Quantity"><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="add-product-are">
                                        ...
                                        <div class="padding-30">
                                            ...
                                            <input class="add-input" type="text" placeholder="NameColor" name="namecolor" id="NameColor"><br><br>
                                            <label class="add-lable" for="">Mã Màu</label><br>
                                            <input class="add-input" type="text" placeholder="CodeColor" name="codecolor" id="CodeColor"><br><br>
                                            <label class="add-lable" for="">Hình Ảnh</label><br><br>
                                            <div class="custom_file_label" onclick="openFilePicker('#file-input-img')">
                                                <div class="padding-30">
                                                    <span>Select files</span>
                                                    <div class="display-flex" id="preview"></div>
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        <select class="add-input" id="category_select" name="group_specification[{{$subGroupSpecification->id}}]">
                                                                                            ...
                                                                                            @foreach($subGroupSpecification->specificationDetails as $specificationDetail)
                                                                                                <option value="{{$specificationDetail->id}}">{{$specificationDetail->description}}</option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="add-product-are">
                                        ...
                                        <div class="padding-30">
                                            ...
                                            <input class="add-input" type="text" placeholder="Base Price" name="price" id="Price"><br><br>
                                            ...
                                            <div class="flex-gap-30">
                                                ...
                                                <label for="" class="discount-type" onclick="handleRadio('radio-2')">
                                                    <div class="padding-20">
                                                        <div class="radio">
                                                            <input id="radio-2" name="radio_2" type="radio" >
                                                            <label for="radio-2" class="radio-label">Phần Trăm</label>
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div id="range-discount" class="padding-30 display-none">
                                                <div class="continent">
                                                    <h3 id="discountPercentage">10%</h3>
                                                </div>
                                                <input name="discount" id="Discount" class="range-discount" type="range" min="0" max="100" step="1" value="10" oninput="updateDiscountPercentage(this.value)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class=" p-3">
                        <button type="submit" class="btn btn-success btn-user btn-icon-split float-right mb-5 p-2">Thêm sản phẩm</button>
                    </div>
                </div>
            </form>
@endsection
