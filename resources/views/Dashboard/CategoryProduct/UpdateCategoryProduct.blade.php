...
@include('sweetalert::alert')
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="add-product-are">
                                        ...
                                        <div class="padding-30">
                                            <label class="add-lable" for="">Tên Danh Mục Sản Phẩm</label><br>
                                            <input class="add-input" type="text" placeholder="Product Name" name="NameProduct" id="NameProduct"><br><br>
                                            ...
                                            <select class="add-input" id="category_select" name="sound_Remote" onclick="show_option('category_select', 'category_input')">
                    ...
                    <div class=" p-3">
                        <a href="#" class="btn btn-success btn-icon-split float-right mb-5">
